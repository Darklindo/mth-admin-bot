...
| `.blacklist list` | Lista a blacklist local do grupo com IDs e motivos disponíveis | Somente `OWNER_IDS` |
...
| `.allban list` | Lista os usuários registrados no allban global | Somente um dos `OWNER_IDS` |
