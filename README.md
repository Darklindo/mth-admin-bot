...
| `.jtbypass URL` | Segue somente redirecionamentos HTTP(S) públicos de `alpharede.com` e `monteolympus.com`; não executa JavaScript nem baixa arquivos | Somente `OWNER_IDS` |
